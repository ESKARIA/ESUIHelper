...
public extension UILabel {
    ...
    static func makeLabel(size: CGFloat = 13, weight: UIFont.Weight = .regular, color: UIColor = UIColor.black) -> UILabel {
        let label = UILabel()
    ...
    func set(text: String, leftIcon: UIImage? = nil, rightIcon: UIImage? = nil, heigh: CGFloat? = nil, width: CGFloat? = nil) {
